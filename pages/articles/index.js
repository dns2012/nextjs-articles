...
export default function ArticleIndex({ data }) {
    ...
    const deleteArticle = async (articleId) => {
        if (window.confirm('Are you sure delete this item ?')) {
            setIsLoading(true)
            const { res } = await axios.delete(`${process.env.API_ENDPOINT}/posts/${articleId}`)
        ...
        <div className={styles.container}>
            ...
            <main className={styles.main}>
                <h3 className={styles.title}>
                    NextJS Article App <a href="https://nextjs.org">List</a>
                </h3>
                ...
                <div className={`${styles.mt2} ${styles.left}`}>
                                ...
                                <tr key={article.id}>
                                    ...
                                    <td>
                                        <div className={styles.flex}>
                                            <button onClick={() => router.push(`/articles/${article.id}`)}>UPDATE</button>
